...
public class AniadirGasto extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnElegirDeudores=view.findViewById(R.id.btnElegirDeudores);
        btnElegirPagador=view.findViewById(R.id.btnElegirPagador);
        btnGuardarLista=view.findViewById(R.id.btnGuardarLista);
        recyclerViewElegirPagador=view.findViewById(R.id.listaDePagador);
        recyclerViewElegirDeudores=view.findViewById(R.id.listaDeDeudores);
